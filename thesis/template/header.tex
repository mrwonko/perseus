...
%% Document properties %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newcommand{\projname}{Perseus}
\newcommand{\titel}{Perseus Compiler \& VM}
\newcommand{\authorname}{Willi Schinmeyer}
\newcommand{\thesisname}{Bachelor Thesis}
\newcommand{\untertitel}{Generating and executing byte code for a strongly typed language}
\newcommand{\Datum}{August 31st 2015}
...
\lstnewenvironment{perseuslisting}[1][]
	{
		\lstset{
			language=C,
			morekeywords={i32,bool,function,mutable,impure,let},
...
\newcommand{\cppinclude}[2][]{
	\lstinputlisting[language=C++,keywordstyle={\underbar},frame=lines,#1]{#2}
}
