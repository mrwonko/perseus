...
{
  BOOST_TEST_MESSAGE( "reading from and moving the instruction pointer" );
...
{
  BOOST_TEST_MESSAGE( "opcode encoding - single-byte opcode" );
...
{
  BOOST_TEST_MESSAGE( "opcode encoding - multi-byte opcode" );
  using perseus::detail::opcode;
